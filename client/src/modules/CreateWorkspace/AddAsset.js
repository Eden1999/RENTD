...
const AddAsset = ({ asset, handleChange, index, handleDelete }) => {
  ...
  return (
    <div className="mb-6 child inline-block-child">
      ...
      <div className="mb-6">
        <label className="label block mb-2 text-sm font-medium text-zinc-400">capacity:</label>
        <input
      ...
      <div className="mb-6">
        <label className="label block mb-2 text-sm font-medium text-zinc-400">cost per hour:</label>
        <input
          className="input 2xl:select-lg font-normal w-full bg-zinc-700 text-white"
          placeholder={"cost"}
          value={cost_per_hour}
